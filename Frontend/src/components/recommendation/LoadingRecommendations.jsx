        ...
        <div className="space-y-6 w-full animate-pulse">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {[1, 2, 3, 4].map((item) => (
                    <div 
                        key={item} 
                        className="bg-gray-800/40 border border-gray-700/60 rounded-2xl overflow-hidden p-4 flex flex-col sm:flex-row gap-4"
                    >
                        {/* Image Skeleton */}
                        <div className="w-full sm:w-44 h-40 bg-gray-700 rounded-xl flex-shrink-0"></div>
