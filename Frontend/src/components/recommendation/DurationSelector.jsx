    ...
    return (
        <div className="bg-gray-800/40 border border-gray-700/60 rounded-xl p-5 shadow-sm transition-all hover:border-gray-600/80">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="bg-gray-900 border border-gray-700 rounded-lg px-3 py-1 text-cyan-400 font-bold text-sm">
            ...
            <input
                ...
                className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-cyan-500 focus:outline-none mb-4"
            />
